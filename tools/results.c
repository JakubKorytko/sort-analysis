...
FILE * open_results_file(char * algorithm_name) {
    ...
    char *algorithm_name_no_spaces = algorithm_name_without_spaces(
        algorithm_name);
    ...
    if (algorithm_name_no_spaces)
        free(algorithm_name_no_spaces);
...
void write_sort_result(
    FILE* results_file, int test_number, int sort_index, int steps) {
